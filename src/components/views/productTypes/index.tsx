  ...
  return (
    <div className='py-16 px-2 space-y-5'>
      ...
      <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 px-2 text-gray-800'>
        ...
        <div className='w-full flex flex-col items-center justify-between md:flex-row col-span-2 bg-cat1 px-12'>
        ...
        <div className='py-4 w-full col-span-2 bg-cat2 flex flex-col justify-center items-center text-white space-y-3'>
